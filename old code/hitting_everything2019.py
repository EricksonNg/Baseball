...
def h_add(game_date, scoredata, ID):
    ...
    if path.exists("2019/" + playername + ".txt"):
        ...
        if scoredata['home']['players'][ID]['position']['abbreviation'] == 'P':
            ...
            if playername != "Pablo Sandoval":
                ...
                with open("2019/" + str(playername) + ".txt", "w") as f:
                    f.write(
                        "{'" + playername + "': {'ID':'" + ID + "', '2019': { 'hitting' : {'dates': [], 'progression': {'averages': [], 'obp': [], "
                ...
                with open("2019/" + str(playername) + ".txt", "w") as f:
                    f.write(
                        "{'" + playername + "': {'ID':'" + ID + "', '2019': { 'hitting' : {{'dates': [], 'progression': "
                                                                "{'averages': [], 'obp': [], 'slg': [], 'ops': [], "
                                                                "'runs': [], 'doubles': [], 'triples': [], "
                                                                "'homeruns': [], 'strikeouts': [], 'walks': [], "
                                                                "'hits': [], 'ab': [], 'sb': [], 'rbi': [], "
                                                                "'lob': []}, 'per_game': {'ab': [], 'strikeouts': [], "
                                                                "'hits': [], 'walks': [], 'runs': [], 'rbi': [], "
                                                                "'sb': [], 'lob': [], 'doubles': [], 'triples': [], "
                                                                "'homeruns': []}}}, 'pitching' : {'dates': [], "
                                                                "'progression': {'era': [], 'innings': [], "
                                                                "'hits': [], 'runs': [], 'earned_runs': [], "
                                                                "'walks': [], 'strikeouts': [], 'homeruns': [], "
                                                                "'doubles': [], 'triples': [], 'ab': [], 'obp': [], "
                                                                "'wins': [], 'losses': [], 'holds': [], "
                                                                "'blown_saves': []}, 'per_game': {'innings': [], "
                                                                "'hits': [], 'runs': [], 'earned_runs': [], "
                                                                "'walks': [], 'strikeouts': [], 'homeruns': [], "
                                                                "'pitches': [], 'strikes': []}}}}}")
                with open("2019/" + str(playername) + ".txt", "r") as FILE:
    ...
    if game_date not in content_dict[playername]['2019']['hitting']['dates']:
        print("Yes")
        with open("2019/" + str(playername) + ".txt", "w") as f:
            try:
                content_dict[playername]['2019']['hitting']['dates'].append(game_date)
                for i in range(len(p_categories)):
                    content_dict[playername]['2019']['hitting']['progression'][p_names[i]].append(p_categories[i])
                for i in range(len(pg_categories)):
                    content_dict[playername]['2019']['hitting']['per_game'][pg_names[i]].append(pg_categories[i])
    ...
    if path.exists("2019/" + playername + ".txt"):
        ...
        if scoredata['away']['players'][ID]['position']['abbreviation'] == 'P':
            ...
            if playername != "Pablo Sandoval":
                ...
                with open("2019/" + str(playername) + ".txt", "w") as f:
                    f.write(
                        "{'" + playername + "': {'ID':'" + ID + "', '2019': { 'hitting' : {'dates': [], 'progression': {'averages': [], 'obp': [], 'slg': [], 'ops': [], 'runs': [], 'doubles': [], 'triples': [], 'homeruns': [], 'strikeouts': [], 'walks': [], 'hits': [], 'ab': [], 'sb': [], 'rbi': [], 'lob': []}, 'per_game': {'ab': [], 'strikeouts': [], 'hits': [], 'walks': [], 'runs': [], 'rbi': [], 'sb': [], 'lob': [], 'doubles': [], 'triples': [], 'homeruns': []}}, 'pitching': {'dates': [], 'progression': {'era': [], 'innings': [], 'hits': [], 'runs': [], 'earned_runs': [], 'walks': [], 'strikeouts': [], 'homeruns': [], 'doubles': [], 'triples': [], 'ab': [], 'obp': [], 'wins': [], 'losses': [], 'holds': [], 'blown_saves': []}, 'per_game': {'innings': [], 'hits': [], 'runs': [], 'earned_runs': [], 'walks': [], 'strikeouts': [], 'homeruns': [], 'pitches': [], 'strikes': []}}}}}")
                with open("2019/" + str(playername) + ".txt", "r") as FILE:
                    content = FILE.read()
                    content_dict = eval(content)
