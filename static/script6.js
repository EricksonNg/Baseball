var updateselectionfield6 = function(){

    var user_selection_field = document.getElementById("year");
    var languages = document.getElementById("player2");
